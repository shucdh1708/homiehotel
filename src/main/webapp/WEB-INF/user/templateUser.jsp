			...
			<div class="row footer-top-29">
				<div class="col-lg-3 col-md-6 col-sm-8 footer-list-29 footer-1">
					...
					<ul>
						<li>
							<p>
								<span class="fa fa-map-marker"></span> District 12.
							</p>
						</li>
						<li><a href="tel:+7-800-999-800"><span
								class="fa fa-phone"></span> +84 456 799 799</a></li>
				...
				<div
					...
					<div class="footer-post mb-4">
						...
						<p class="small">
							<span class="fa fa-clock-o"></span> November 11, 2021
						</p>
					</div>
				...
				<div
					...
					<div class="footer-post mb-4">
						<p class="small">Bank <strong>SACOMBANK</strong> Tuy Hoa Branch</p>
						<p class="small">Holder: CAO DUC HUY</p>
						<p class="small">Account Number: 0400 8887 5585</p>
					</div>
					<div class="footer-post">
						<p class="small">Bank <strong>AGRIBANK</strong> HOAI NHON Branch</p>
						<p class="small">Holder: NGUYEN LE DUY</p>
						<p class="small">Account Number: 0000 0000 0000 0000</p>
					</div>
				</div>
			</div>
		</div>
